...
unrealRootPath=/home/david/Dart/UnrealEngine
SimulationRootPath=/home/david/Dart/Simulation

gameProjectFile=/home/david/Dart/Simulation/Simulation.uproject
...
include(SimulationSource.pri)
include(SimulationHeader.pri)
include(SimulationConfig.pri)
include(SimulationIncludes.pri)
include(SimulationDefines.pri)

Simulation-Linux-Debug.commands = $$build Simulation Linux Debug  -project="\"$$gameProjectFile\"" $$args
Simulation-Linux-DebugGame.commands = $$build Simulation Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Simulation-Linux-Shipping.commands = $$build Simulation Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Simulation-Linux-Test.commands = $$build Simulation Linux Test  -project="\"$$gameProjectFile\"" $$args
Simulation.commands = $$build Simulation Linux Development  -project="\"$$gameProjectFile\"" $$args

SimulationEditor-Linux-Debug.commands = $$build SimulationEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
SimulationEditor-Linux-DebugGame.commands = $$build SimulationEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SimulationEditor-Linux-Shipping.commands = $$build SimulationEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SimulationEditor-Linux-Test.commands = $$build SimulationEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
SimulationEditor.commands = $$build SimulationEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	Simulation-Linux-Debug \
	Simulation-Linux-DebugGame \
	Simulation-Linux-Shipping \
	Simulation-Linux-Test \
	Simulation \
	SimulationEditor-Linux-Debug \
	SimulationEditor-Linux-DebugGame \
	SimulationEditor-Linux-Shipping \
	SimulationEditor-Linux-Test \
	SimulationEditor \
